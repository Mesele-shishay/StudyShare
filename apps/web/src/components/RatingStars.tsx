  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <path
            fill={rating >= 1 ? '#F5C102' : '#D5CEFC'}
            stroke={rating >= 1 ? '#F5C102' : '#D5CEFC'}
            strokeLinecap='round'
      ...
      >
        ...
        >
          <path
            fill={rating >= 2 ? '#F5C102' : '#D5CEFC'}
            stroke={rating >= 2 ? '#F5C102' : '#D5CEFC'}
            strokeLinecap='round'
            strokeLinejoin='round'
            d='m20 4.463 4.702 9.525a.5.5 0 0 0 .376.273l10.514 1.537-7.608 7.41a.5.5 0 0 0-.144.443l1.796 10.468-9.403-4.945a.5.5 0 0 0-.466 0l-9.403 4.945 1.795-10.468a.5.5 0 0 0-.144-.442l-7.608-7.41 10.515-1.538a.5.5 0 0 0 .376-.273L20 4.463Z'
          />
      ...
      >
        ...
        >
          <path
            fill={rating >= 3 ? '#F5C102' : '#D5CEFC'}
            stroke={rating >= 3 ? '#F5C102' : '#D5CEFC'}
            strokeLinecap='round'
            strokeLinejoin='round'
            d='m20 4.463 4.702 9.525a.5.5 0 0 0 .376.273l10.514 1.537-7.608 7.41a.5.5 0 0 0-.144.443l1.796 10.468-9.403-4.945a.5.5 0 0 0-.466 0l-9.403 4.945 1.795-10.468a.5.5 0 0 0-.144-.442l-7.608-7.41 10.515-1.538a.5.5 0 0 0 .376-.273L20 4.463Z'
          />
      ...
      >
        ...
        >
          <path
            fill={rating >= 4 ? '#F5C102' : '#D5CEFC'}
            stroke={rating >= 4 ? '#F5C102' : '#D5CEFC'}
            strokeLinecap='round'
            strokeLinejoin='round'
            d='m20 4.463 4.702 9.525a.5.5 0 0 0 .376.273l10.514 1.537-7.608 7.41a.5.5 0 0 0-.144.443l1.796 10.468-9.403-4.945a.5.5 0 0 0-.466 0l-9.403 4.945 1.795-10.468a.5.5 0 0 0-.144-.442l-7.608-7.41 10.515-1.538a.5.5 0 0 0 .376-.273L20 4.463Z'
          />
      ...
      <button onClick={() => setRating(5)} style={{borderRadius: 20}}>
        ...
        >
          <path
            fill={rating >= 5 ? '#F5C102' : '#D5CEFC'}
            stroke={rating >= 5 ? '#F5C102' : '#D5CEFC'}
            strokeLinecap='round'
            strokeLinejoin='round'
            d='m20 4.463 4.702 9.525a.5.5 0 0 0 .376.273l10.514 1.537-7.608 7.41a.5.5 0 0 0-.144.443l1.796 10.468-9.403-4.945a.5.5 0 0 0-.466 0l-9.403 4.945 1.795-10.468a.5.5 0 0 0-.144-.442l-7.608-7.41 10.515-1.538a.5.5 0 0 0 .376-.273L20 4.463Z'
          />
